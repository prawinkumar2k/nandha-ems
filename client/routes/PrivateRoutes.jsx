...
const AdminPendingDevices = lazy(() => import("@/modules/admin/pages/devices/PendingDevices"));
...
const FacultyHallTickets = lazy(() => import("@/modules/faculty/pages/HallTickets"));
...
export function PrivateRoutes() {
  return (
    <Routes>
      ...
      <Route path={ROUTES.LOGIN} element={<RootRedirect />} />
      ...
      <Route path={ROUTES.ADMIN_DEVICES_PENDING} element={<ProtectedRoute allowedRoles="admin"><S><AdminPendingDevices /></S></ProtectedRoute>} />
      ...
      <Route path={ROUTES.ADMIN_SECURITY_EVENTS} element={<ProtectedRoute allowedRoles="admin"><S><AdminSecurityEvents /></S></ProtectedRoute>} />
      ...
      <Route path={ROUTES.FACULTY_CREATE_EXAM} element={<ProtectedRoute allowedRoles={["admin", "faculty", "hod"]}><S><FacultyCreateExam /></S></ProtectedRoute>} />
      <Route path={ROUTES.FACULTY_QUESTION_BANK} element={<ProtectedRoute allowedRoles={["admin", "faculty", "hod"]}><S><FacultyQuestionBank /></S></ProtectedRoute>} />
      ...
      <Route path={ROUTES.FACULTY_HALL_TICKETS} element={<ProtectedRoute allowedRoles={["faculty", "hod"]}><S><FacultyHallTickets /></S></ProtectedRoute>} />
